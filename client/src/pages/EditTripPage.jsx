  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-8">
        <button
          onClick={() => navigate(`/${id}`)}
          className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 mb-4 transition-colors"
        >
          <ArrowLeft size={20} />
        ...
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div className="bg-primary-100 dark:bg-primary-900/30 p-4 rounded-full">
              <PenTool className="h-12 w-12 text-primary-600 dark:text-primary-400" />
            </div>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            {t("editTrip.title")}
          </h1>
          <p className="text-gray-600 dark:text-gray-400">{t("editTrip.subtitle")}</p>
        </div>
      </div>
